# PI Review Packet — ttrA-api-web-20260712-100649
...
- **ttrA-api-web-20260712-100649-q0001** — L3 · research-mechanistic · seeded · 3 analyses
    Characterize cohort A's TTR/hereditary ATTR amyloidosis population: patient count, most frequent diagnoses, and whether the expected cardiac vs. neuropathic phenotype is present among amyloidosis (ICD E85.x) patients.
- **ttrA-api-web-20260712-100649-q0002** — L4 · clinical-management · spawned (from ttrA-api-web-20260712-100649-q0001) · 5 analyses
    Among E85.x amyloidosis patients, what is the balance of cardiac phenotype (cardiomyopathy, heart failure, cardiomegaly, abnormal ECG) versus neuropathic phenotype (polyneuropathy, peripheral neuropathy, carpal tunnel), and do individual patients show mixed phenotype?

**Edges:** ttrA-api-web-20260712-100649-q0001→ttrA-api-web-20260712-100649-q0002 (spawns)
