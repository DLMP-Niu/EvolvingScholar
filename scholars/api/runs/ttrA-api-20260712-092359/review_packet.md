# PI Review Packet — ttrA-api-20260712-092359

**Scholar:** api  ·  **Project:** TTR-ATTR  ·  **Cohort:** A  ·  **Run:** 1

**Seed:** Seed question: Using cohort A's EMR data, characterize the TTR / hereditary ATTR amyloidosis cohort — how many patients there are, the most frequent diagnoses, and whether the expected cardiac vs. neuropathic phenotype is present among amyloidosis (ICD E85.x) patients.

## Registered questions (trajectory)
- **ttrA-api-20260712-092359-q0001** — L3 · research-mechanistic · seeded · 4 analyses
    Characterize cohort A's TTR/hereditary ATTR amyloidosis cohort: patient count, most frequent diagnoses, and whether the expected cardiac vs. neuropathic phenotype is present among amyloidosis (ICD E85.x) patients.
- **ttrA-api-20260712-092359-q0002** — L4 · clinical-management · spawned (from ttrA-api-20260712-092359-q0001) · 2 analyses
    Among the 189 amyloidosis (E85.x) patients, what fraction carry cardiac-phenotype markers (I43/I50/I51.7/amyloid cardiomyopathy) vs neuropathic markers (E85.1/G62.9/G99.0 peripheral neuropathy), and how much overlap (mixed phenotype) exists?
- **ttrA-api-20260712-092359-q0003** — L5 · research-mechanistic · self-generated (from ttrA-api-20260712-092359-q0002) · 4 analyses
    Could diabetes/hyperglycemia confound the neuropathic phenotype signal in the E85.x cohort — i.e., do neuropathy-coded patients also have elevated glucose / diabetes diagnoses that offer an alternative explanation for peripheral neuropathy?

**Edges:** ttrA-api-20260712-092359-q0001→ttrA-api-20260712-092359-q0002 (spawns), ttrA-api-20260712-092359-q0002→ttrA-api-20260712-092359-q0003 (spawns)
